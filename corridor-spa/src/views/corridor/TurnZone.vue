  ...
  <div class="turn-zone-page">
    ...
    <div class="custom-card p-5 mb-4">
      <el-form :model="filter" class="search-form" label-width="110px">
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="转弯区ID">
              <el-select v-model="filter.zoneId" placeholder="请选择转弯区ID" class="w-full custom-el-select">
          ...
          <el-col :span="6">
            <el-form-item label="转弯区名称">
              <el-input v-model="filter.name" placeholder="请输入转弯区名称" class="w-full custom-el-input" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="转弯区关联廊道">
              <el-input v-model="filter.corridorRef" placeholder="请输入转弯区关联廊道" class="w-full custom-el-input" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
        ...
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="启用状态">
              <el-select v-model="filter.status" placeholder="请选择启用状态" class="w-full custom-el-select">
    ...
    <div class="custom-card flex-1 flex flex-col p-5 overflow-hidden">
      ...
      <div class="flex justify-end gap-3 mb-4">
        <el-button class="custom-btn-outline-primary" @click="handleCreate">
          <el-icon class="mr-1"><Plus /></el-icon> 新建转弯区
        </el-button>
      ...
      >
        ...
        <el-table-column prop="zoneId" label="转弯区ID" min-width="100" />
        <el-table-column prop="name" label="转弯区名称" min-width="160" show-overflow-tooltip />
        <el-table-column prop="corridorRef" label="转弯区关联廊道" min-width="250" align="center" show-overflow-tooltip />
...
const filter = reactive({ zoneId: '', name: '', corridorRef: '', status: '' })
const pagination = reactive({ page: 1, pageSize: 10 })

const list = ref([
  { zoneId: '91', name: '1111', corridorRef: '416测试001, 0416测试001', status: true, createTime: '2026-04-16 16:10:36' },
  { zoneId: '90', name: 'test0416', corridorRef: '测试廊道0416, 测试廊道0416_2', status: true, createTime: '2026-04-16 15:06:29' },
  { zoneId: '89', name: '转弯区0416', corridorRef: '测试廊道0416, 测试廊道0416_2', status: true, createTime: '2026-04-16 14:55:43' },
  { zoneId: '88', name: '1337', corridorRef: '0416测试001, 0416测试002', status: true, createTime: '2026-04-16 13:37:29' },
  { zoneId: '86', name: '测试转弯区416', corridorRef: '416测试001, 测式0416-002', status: true, createTime: '2026-04-16 10:23:19' },
  { zoneId: '85', name: '测试转弯区', corridorRef: '0415测试廊道, 415测试001', status: true, createTime: '2026-04-15 20:43:31' },
  { zoneId: '72', name: 'G92_3', corridorRef: 'G92廊道2, G92廊道1', status: false, createTime: '2026-03-27 17:08:35' },
  { zoneId: '71', name: 'G92_2', corridorRef: 'G92廊道2, G92廊道1', status: false, createTime: '2026-03-27 17:00:37' },
  { zoneId: '70', name: 'G92', corridorRef: 'G92廊道2, G92廊道1', status: false, createTime: '2026-03-27 16:51:18' },
])
...
function resetFilters() {
  Object.assign(filter, { zoneId: '', name: '', corridorRef: '', status: '' })
  doSearch()
}
...
<style scoped>
.turn-zone-page { flex: 1; display: flex; flex-direction: column; padding: 16px; background: #f0f2f5; height: 100%; overflow: hidden; box-sizing: border-box; }
